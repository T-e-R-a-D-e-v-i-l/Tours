...
function renderMenu(tours) {
  ...
  buttons.forEach((button, index) => {
    ...
    buttons.forEach((button, index) => {
    document.getElementById(`filterButton${index}`).addEventListener('click',() => {
...
// tours.forEach ((tour) => {
//     document.getElementById(`orderButton${tour.id}`).addEventListener('click', () => openModalCard(tour.id))
// })

// const modalCardMenu = document.getElementById('modalCardMenu')

// function openModalCard(id) {
    
//     modalCardMenu.style.display = 'flex'
...
tours.forEach ((tour) => {
    document.getElementById(`orderButton${tour.id}`).addEventListener('click', () => {openModal(tour.id)
    })
})
